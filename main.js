    ...
    function onReadyMyDW(NoDialog){
        ...
        if(NoDialog == false){
            var repeat = setInterval(() => {
                ...
                if($('article[data-snig="canDownload"], section:visible > main > div > div.xdt5ytf > div[data-snig="canDownload"], div[id^="mount"] > div > div > div.x1n2onr6.x1vjfegm div[data-snig="canDownload"]').length > 0) clearInterval(repeat);
